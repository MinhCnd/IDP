...
def test_ls_annotations_to_layoutlmv3():
    ...
    assert result == {
        ...
        "bboxes": [[861, 395, 898, 408], [856, 496, 896, 510], [855, 509, 898, 522], [854, 521, 896, 531], [849, 533, 897, 543], [848, 618, 897, 635]],
        "ner_tags": ['B-BALANCE_STILL_OWING', 'B-WATER_CONSUMPTION', 'B-WASTEWATER_CONSUMPTION', 'B-WASTEWATER_FIXED', 'B-BALANCE_CURRENT_CHARGES', 'B-TOTAL_DUE'],
    }
